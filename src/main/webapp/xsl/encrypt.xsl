...
<div class="promptHead">
  <xsl:value-of select="/cryptoPrompt/resources/msg[@key='label.encrypt']/@value" />
</div>
  ...
  <table border="0" width="100%" cellpadding="10">
    ...
    <tr>
      <td class="formParm1" nowrap="nowrap">
        <xsl:value-of select="/cryptoPrompt/resources/msg[@key='label.fileToEncrypt']/@value" />:
      </td>
      <td class="formParm2">
    ...
    <tr id="buttonRow">
      <td>
        <input type="button">
          ...
          <xsl:attribute name="value"><xsl:value-of select="/cryptoPrompt/resources/msg[@key='button.encrypt']/@value" /></xsl:attribute>
        </input>
      </td>
