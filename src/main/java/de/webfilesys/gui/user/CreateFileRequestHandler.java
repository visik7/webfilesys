...
public class CreateFileRequestHandler extends UserRequestHandler
{
	...
	protected void process()
	{
		...
		if (mobile != null) 
		{
            output.println("<META HTTP-EQUIV=\"REFRESH\" CONTENT=\"0; URL=/doxee-internal/servlet?command=mobile&cmd=folderFileList&absPath=" + UTF8URLEncoder.encode(actPath) + "\">");
		}
		else
		{
	        output.println("<META HTTP-EQUIV=\"REFRESH\" CONTENT=\"0; URL=/doxee-internal/servlet?command=exp&expand=" + UTF8URLEncoder.encode(actPath) + "&fastPath=true\">");
		}
