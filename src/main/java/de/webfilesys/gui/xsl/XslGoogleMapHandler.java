...
public class XslGoogleMapHandler extends XslRequestHandlerBase
{
	...
	protected void process()
	{
		...
		ProcessingInstruction xslRef = doc.createProcessingInstruction("xml-stylesheet", "type=\"text/xsl\" href=\"/doxee-internal/xsl/googleMap.xsl\"");
		...
		this.processResponse("googleMap.xsl");
    }
